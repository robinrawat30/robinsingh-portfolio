      ...
      <div>
        ...
        >
          ...
          <p className="text-accent-foreground mt-5 sm:w-2/3 mx-auto">
            Providing end-to-end web development solutions, including responsive frontend design,
            secure backend systems, and full-stack application development tailored to your business needs.
          </p>
        </MotionDiv>
          ...
          {SERVICES.map((service, i) => (
            ...
            >
              <Image
                ...
                height={55}
                alt="3d"
                className="group-hover:scale-110 rounded-lg duration-200"
              />

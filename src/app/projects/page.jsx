...
const projects = [
  {
    ...
    desc: "A sleek and dynamic personal portfolio built with Next.js for fast performance, styled using Tailwind CSS for a clean, responsive UI, and enhanced with Framer Motion for smooth, interactive animations—designed to showcase projects and skills with style and speed.",
    category: "frontend",
    image: "/pro1.png",
